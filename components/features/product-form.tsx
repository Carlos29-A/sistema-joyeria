    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
      ...
      <AnimatePresence>
        {skuPreview && (
          <motion.div
            ...
            exit={{ opacity: 0, y: -10 }}
            className="flex items-center gap-3 rounded-xl border border-emerald-200 bg-gradient-to-br from-emerald-50 to-emerald-50/50 p-4"
          >
            ...
            <div>
              ...
              <p className="mt-0.5 font-mono text-lg font-semibold text-emerald-900">
                {skuPreview}
              </p>
            </div>
          </motion.div>
      ...
      <div>
        <div className="mb-4 flex items-center gap-2">
          <h3 className="font-serif text-lg text-stone-900">Clasificación</h3>
      ...
      <div>
        <div className="mb-4 flex items-center gap-2">
          <h3 className="font-serif text-lg text-stone-900">Detalles</h3>
          <span className="h-px flex-1 bg-stone-200" />
        </div>
        <div className="grid gap-5 sm:grid-cols-2">
          {/* Tipo de joya */}
      ...
      <div>
        <div className="mb-4 flex items-center gap-2">
          <h3 className="font-serif text-lg text-stone-900">Comercial</h3>
          <span className="h-px flex-1 bg-stone-200" />
        </div>
      ...
      <div>
        <div className="mb-4 flex items-center gap-2">
          <h3 className="font-serif text-lg text-stone-900">Artesanal</h3>
          <span className="h-px flex-1 bg-stone-200" />
        </div>
        <div className="space-y-4">
          <label className="flex items-center gap-3 cursor-pointer group">
            <input
              id="artesanal"
              type="checkbox"
              className="h-4 w-4 rounded border-stone-300 text-emerald-700 focus:ring-emerald-500 transition-colors"
              {...register("artesanal")}
            />
              ...
              >
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    className="flex w-full rounded-lg border border-stone-300 bg-white px-3.5 py-2.5 text-sm text-stone-900 placeholder:text-stone-400 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-500/30 focus-visible:border-emerald-600 transition-all"
      ...
      <div>
        <div className="mb-4 flex items-center gap-2">
          <h3 className="font-serif text-lg text-stone-900">Imágenes</h3>
          <span className="h-px flex-1 bg-stone-200" />
        </div>
        <ImageUpload
          value={images}
